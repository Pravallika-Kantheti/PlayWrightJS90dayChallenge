function printHello() {
    ...
    let a = 20; // This variable is scoped to the function, it does not affect the outer variable 'a'
    ...
    console.log("F->", a); // Output: 20 (this will print the local variable 'a' which is 20, it does not override the previous value of 'a' in the function scope)
}
